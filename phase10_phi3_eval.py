...
def run_extraction():
    # Written to a new filename (not the original phi3_truthfulqa.csv) so the
    # original reduced-descriptor-bank cache is preserved rather than overwritten.
    out_csv = "phase10_results/phi3_truthfulqa_4stat.csv"
    ...
    df = df.head(150) # 300 total examples for speed
